...
int main()
{
    ...
    Search_in_graph search_in_graph({module_rule105, module_rule110, module_rule108,module_rule102,module_rule106,
        module_rule111, module_rule112,  module_rule115, module_rule104 ,module_rule101, module_rule103,
           module_rule107, module_rule113, module_rule109,
        module_rule114,  },
        node14,
        { node31, node1, node2, node4, node9, node18, node19}, 8);
